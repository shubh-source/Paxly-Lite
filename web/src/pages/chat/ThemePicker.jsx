    ...
    <div style={{ position: 'fixed', inset: 0, zIndex: 1000, background: 'rgba(0,0,0,0.75)', backdropFilter: 'blur(12px)', display: 'flex', alignItems: 'flex-end' }}>
      ...
      <div style={{
        ...
        <div style={{ maxHeight: '60vh', overflowY: 'auto', paddingRight: 5 }}>
          <h4 style={{ color: 'var(--muted)', fontSize: '0.8rem', marginBottom: 10, textTransform: 'uppercase', letterSpacing: 1, fontWeight: 700 }}>Free Themes</h4>
          ...
          <h4 style={{ color: '#C9A96E', fontSize: '0.8rem', marginBottom: 10, textTransform: 'uppercase', letterSpacing: 1, fontWeight: 700, display: 'flex', alignItems: 'center', gap: 6 }}>
            💎 Premium 3D Themes
          </h4>

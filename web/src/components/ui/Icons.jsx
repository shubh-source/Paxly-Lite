...
const IconWrapper = ({ children, size = 24, color = 'currentColor', stroke = 2, className = '' }) => (
  <svg
...
export const Icons = {
  ...
  Chat: (props) => (
    <IconWrapper {...props}>
      ...
      <path d="M8 9h8" strokeOpacity="0.5" />
      <path d="M8 13h6" strokeOpacity="0.5" />
    </IconWrapper>
  ),
  ...
  LoveNote: (props) => (
    <IconWrapper {...props}>
      ...
      <path d="M12 19c.5 0 1-.2 1.4-.5.4.3.9.5 1.4.5 1.2 0 2.2-1 2.2-2.2 0-1.2-2.2-3.8-5-3.8s-5 2.6-5 3.8c0 1.2 1 2.2 2.2 2.2.5 0 1-.2 1.4-.5.4.3.9.5 1.4.5Z" fill="currentColor" stroke="none" opacity="0.3" />
    </IconWrapper>
  ),
  ...
  Milestone: (props) => (
    <IconWrapper {...props}>
      ...
      <path d="M3 10h18" />
      <path d="M12 14l.6 1.2 1.4.2-1 1 .2 1.4-1.2-.6-1.2.6.2-1.4-1-1 1.4-.2.6-1.2Z" fill="currentColor" stroke="none" opacity="0.8" />
    </IconWrapper>
  ),
  ...
  Send: (props) => (
    <IconWrapper {...props}>
      ...
      <path d="M22 2 11 13" strokeOpacity="0.6" />
    </IconWrapper>
  ),
  ...
  Cloud: (props) => (
    <IconWrapper {...props}>
      <path d="M17.5 19c2.5 0 4.5-2 4.5-4.5 0-2.3-1.7-4.1-3.9-4.4a7 7 0 1 0-13.2 2c-2.2.3-3.9 2.1-3.9 4.4C1 17 3 19 5.5 19Z" />
    </IconWrapper>
  ),
  ...
  Loader: ({ size = 24, className = '', style }) => (
    ...
    >
      <defs>
        <linearGradient id="loaderGrad" x1="0%" y1="100%" x2="0%" y2="0%">
